...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
    ...
    <div class="collapse navbar-collapse " id="navbarSupportedContent">
        ...
        <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
            ...
            <li><a class="dropdown-item btn disabled" href="#">view complains</a></li>
    ...
    <?php
        $query="Select * FROM project.sellercmp S WHERE S.sellerid=\"$seller\"" ;   
            ...
            {   
                ...
                foreach($r as $cmp)
                {
                    echo "<div class='shadow-sm p-3 mb-5 bg-body rounded'>
                        <section>Complain Id : <strong>{$cmp['cmpid']}</strong></section>
                        <section>{$cmp['des']}</section>
                        </div>";
                }
            }
            else {
                echo "<div class=\"mt-3\" ><h1>No complaints to display!</h1></div>";
            }
        echo "</div>";
    ?> 
