...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
    ...
    <div class="collapse navbar-collapse " id="navbarSupportedContent">
        ...
        <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
            ...
            <li><a class="dropdown-item btn disabled" href="#">Report Issues</a></li>
    ...
    <form class="mt-3" method="post" action="buyer_make_complain.php" >
    ...
    <?php
        if(isset($_POST['submit']))
        {
            ...
            $cmp=$_POST['complain'];
            $cmpid='cmp'. uniqid();
            $query="INSERT INTO project.buyercmp VALUES (\"$buyer\",\"$cmpid\",\"$cmp\")";
