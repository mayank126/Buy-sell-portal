...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
    ...
    <div class="collapse navbar-collapse " id="navbarSupportedContent">
        ...
        <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
            ...
            <li><a class="dropdown-item btn disabled" href="#">Cart</a></li>
    ...
    <?php
            $query="SELECT P.name,P.cost FROM project.product P, project.cart C where C.productid=P.productid and C.buyerid=\"$buyer\""; 
                ...
                {  
                    ...
                    foreach($r as $item)
                    {
                        echo "<div class='shadow-sm p-3 my-2 bg-body rounded'>
                            <section>Product Name : {$item['name']}</section>
                            <section>Cost : {$item['cost']}/-</section>
                            </div>";
                    }
                    echo "<a href=\"checkout.php\" class=\"btn btn-primary btn-lg btn-block\">CheckOut</a>";
                }
            else
            {
                echo "<div class='shadow-sm p-3 mb-5 bg-body rounded'>The cart is empty!!</div>";
            }
            echo "</div>";
        ?>
