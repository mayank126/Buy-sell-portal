...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
    ...
    <?php
            $query="SELECT O.* , S.name, S.phoneno, P.name AS prodname,P.cost from project.orders O, project.seller S, project.product P where P.productid=O.productid and S.sellerid=P.sellerid and O.buyerid=\"$buyer\" AND O.status='pending'"; 
